...
<div style="width: 1000px">
    ...
    <table border="0" width="100%">
        <div>
            <thead>
            <th style="width: 60%;font-size: 48px;text-align: left"><img src="dist/img/logo.png" class="img"
                                                                         alt="User Image"></th>

            <th style="width: 40%;font-size: 16px;color: black;text-align: center; font-family:sans-serif; ">1B Abayomi
                Shonuga Crescent <br>Off Dele Adedeji Street, <br> Lekki Phase 1, <br> Lagos Nigeria.
            </th>
            </thead>
        </div>
    </table>
    ...
    <table border="0" width="100%">
        <div>
            <thead>
            <th style="width: 60%;font-size: 16px;text-align: left;">Invoice No: @php echo rand() @endphp <br>Invoice
                Date: @php echo date("d/m/Y"); @endphp <br> Due
                Date:@php echo date('d/m/Y', strtotime('+1 months'));  @endphp</th>
    ...
    <table border="0" width="100%">
        <div>
            <thead>
            @if($organ_get)
                <th style="width: 60%;font-size: 16px;text-align: left;">Company Name: {{$organ_get->orgName}} <br>Address: {{$organ_get->orgAddress}}
                    <br>Country: {{$organ_get->country}} <br>GSTIN ID: <br>VAT No:
                </th>
            </thead>
            @endif
        </div>
    ...
    <table border="0" width="100%">
        ...
        <tbody>
        @if($additem)
            @php $total=0; $i=1;$dtotal=0; @endphp
    ...
    <table border="0" width="100%">
        ...
        <tr>
            ...
            @if($invoice->hasvat=='1')
                ...
                <td width="20%" style="text-align: left;">
                    <b> {!! $addition->currency == 'dollar' ? '$' : '&#8358' !!} {{number_format($dtotal * 0.075 ,2) }}</b>
                </td>
